...
<body>
	<h2> Management of Entrepreneurship and Technology </h1>
	<h2> Higher Education </h2>
	<h1> Unit of Study Outline </h1>
	<h1> INT3306 </h1>
	<h1> Web Development </h1>
	<h2> Semester 2 2023</h2>
	<p> 
	<img src="lab02_files-1/unitoutline_logo.png"
	alt="HSB"
	...
	<h3> Aims </h3>
		<p> This unit is designed to introduce the technology of the Internet and World Wide Web and to develop an understanding of the technologies associated with programming for the World Wide Web.
Learning Objectives </p>
	...
	<ol>
		...
		<li>	Describe the protocols of the World Wide Web.
	...
	<h3>Resources and Reference Material</h3>
		...
		<ul>
			<li>Glenn Johnson, <em>Training Guide Programming in HTML5 with JavaScript and CSS3</em>, Microsoft, 2013</li>
		</ul>
		<p><em>Note: Please refer to Blackboard for some useful materials for this unit under Web Links.</em></P>
	<h3>Blackboard Site for this Unit of Study</h3>
		<p>Important information concerning this unit of study is placed on the Swinburne course management system (Blackboard/iLearn), accessible via <a href="http://ilearn.swin.edu.au/" >http://ilearn.swin.edu.au/ </a>
	...
	<ul>
		...
		<p><em>Discussion Boards on Blackboard will be open for General discussion about this Unit, and for discussion about Assignments. Please participate in these discussion forums, and post queries through these forums, rather than individual emails to the Lecturer or Tutors.</em></p>
</body>
</html>